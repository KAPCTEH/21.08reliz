...
GitHub repository/PR/branch protection/tag, повтор полной UI-матрицы, clean-ZIP test rerun, installer executable acceptance, live two-account/VPS verification и deploy/release proof. До их завершения статус не может быть GO.
