...
- Установка на физический ПК: `PASS`; версия, запуск и SHA-256 установленного EXE совпали с текущим CI-артефактом.
- Вход нового владельца: `PASS`; новый склад визуально пуст, локальная scope-изоляция подтверждена.
- Полная живая проверка: `IN PROGRESS`; подтверждены настройки и экран заказов, дальнейший автоматизированный обход временно остановлен timeout тестового средства.
