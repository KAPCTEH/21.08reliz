...
Публичные staging и production Worker работают, но каталоги не опубликованы. В репозитории пока нет доверенного публичного ключа; оригинальный приватный ключ в разрешённой рабочей области не найден. До отдельно подтверждённой первичной процедуры доверия, создания реального payload и прохождения staging автообновления остаются выключенными.
