...
async function runVisualQa() {
  ...
  try{
    ...
    await win.webContents.executeJavaScript("showView('programSettings');document.querySelector('#jfUpdateCenter')?.scrollIntoView({block:'start'});");
    await waitForRenderer(win,"document.querySelector('#jfUpdateCenter[data-update-ready=\"1\"]')?.getBoundingClientRect().height>0");
    await new Promise(resolve=>setTimeout(resolve,500));
