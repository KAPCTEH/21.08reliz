...
function buildPendingEntityChanges({snapshot=null,knownEntities=cloudSyncState.known,conflicts=cloudSyncState.conflicts,queue=requireLocalOutbox(),context=null,allowInferredDeletes=true,suppressedDeletes=null,serverEntities=[],reason='durable_dirty_recovery'}={}){
